const Footer = () => {
    return <footer className="bg-primary text-accent px-[40px] py-[20px] pb-[20px] lg:px-[40px] lg:py-[80px] lg:pb-[20px] flex flex-col gap-[40px]">
        <div className="flex flex-col lg:flex-row justify-between gap-[40px]">
            <div className="flex flex-col  gap-[20px] max-w-[413px]">
                <img  src="../src/assets/logo.png" alt="logo" className="max-w-[226px] cursor-pointer" />
                <p className="font-sub-body">Your goal is our target. Not anything in between. We use online marketing platforms and tools to achieve single objective - your business results.</p>
            </div>
